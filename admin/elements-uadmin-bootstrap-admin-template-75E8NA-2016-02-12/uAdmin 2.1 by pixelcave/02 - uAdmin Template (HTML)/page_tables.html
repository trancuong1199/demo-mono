                    ...
                    <nav id="primary-nav">
                        <ul>
                            ...
                            <li class="active">
                                ...
                                <ul>
                                    <li>
                                        <a href="page_tables.html" class="active"><i class="fa fa-tint"></i>Styles</a>
                                    </li>
                                    <li>
                ...
                <div id="page-content">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td class="text-center"><input type="checkbox" id="check1-td2" name="check1-td2"></td>
                            ...
                            <tr>
                                <td class="text-center"><input type="checkbox" id="check1-td3" name="check1-td3"></td>
                            ...
                            <tr>
                                <td class="text-center"><input type="checkbox" id="check1-td4" name="check1-td4"></td>
                    ...
                    <table class="table table-condensed">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center"><input type="checkbox" id="check2-td1" name="check2-td1"></td>
                                <td class="text-center">1</td>
                                <td><a href="javascript:void(0)">username1</a></td>
                                <td class="hidden-xs hidden-sm">user1@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                            ...
                            <tr>
                                <td class="text-center"><input type="checkbox" id="check2-td2" name="check2-td2"></td>
                                <td class="text-center">2</td>
                                <td><a href="javascript:void(0)">username2</a></td>
                                <td class="hidden-xs hidden-sm">user2@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                            ...
                            <tr>
                                <td class="text-center"><input type="checkbox" id="check2-td3" name="check2-td3"></td>
                                <td class="text-center">3</td>
                                <td><a href="javascript:void(0)">username3</a></td>
                                <td class="hidden-xs hidden-sm">user3@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                            ...
                            <tr>
                                <td class="text-center"><input type="checkbox" id="check2-td4" name="check2-td4"></td>
                                <td class="text-center">4</td>
                                <td><a href="javascript:void(0)">username4</a></td>
                                <td class="hidden-xs hidden-sm">user4@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                    ...
                    <table class="table table-striped">
                        ...
                        <tbody>
                            <tr>
                                <td class="cell-small text-center"><input type="checkbox" id="check4-td1" name="check4-td1"></td>
                            ...
                            <tr>
                                <td class="cell-small text-center"><input type="checkbox" id="check4-td2" name="check4-td2"></td>
                                <td class="cell-small text-center">2</td>
                                <td><a href="javascript:void(0)">username2</a></td>
                                <td class="hidden-xs hidden-sm">user2@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                                <td class="hidden-xs hidden-sm">Last</td>
                            ...
                            <tr>
                                <td class="cell-small text-center"><input type="checkbox" id="check4-td3" name="check4-td3"></td>
                                <td class="cell-small text-center">3</td>
                                <td><a href="javascript:void(0)">username3</a></td>
                                <td class="hidden-xs hidden-sm">user3@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                                <td class="hidden-xs hidden-sm">Last</td>
                            ...
                            <tr>
                                <td class="cell-small text-center"><input type="checkbox" id="check4-td4" name="check4-td4"></td>
                                <td class="cell-small text-center">4</td>
                                <td><a href="javascript:void(0)">username4</a></td>
                                <td class="hidden-xs hidden-sm">user4@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                                <td class="hidden-xs hidden-sm">Last</td>
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td class="cell-small text-center"><input type="checkbox" id="check5-td1" name="check5-td1"></td>
                                <td class="cell-small text-center">1</td>
                                <td><a href="javascript:void(0)">username1</a></td>
                                <td class="hidden-xs hidden-sm">user1@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                            ...
                            <tr>
                                <td class="cell-small text-center"><input type="checkbox" id="check5-td2" name="check5-td2"></td>
                                <td class="cell-small text-center">2</td>
                                <td><a href="javascript:void(0)">username2</a></td>
                                <td class="hidden-xs hidden-sm">user2@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                            ...
                            <tr>
                                <td class="cell-small text-center"><input type="checkbox" id="check5-td3" name="check5-td3"></td>
                                <td class="cell-small text-center">3</td>
                                <td><a href="javascript:void(0)">username3</a></td>
                                <td class="hidden-xs hidden-sm">user3@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                    ...
                    <table class="table table-borderless">
                        ...
                        <tbody>
                            <tr class="success">
                                <td class="cell-small text-center"><input type="checkbox" id="check7-td0" name="check7-td0"></td>
                                <td class="text-center">1</td>
                                <td><a href="javascript:void(0)">username1</a></td>
                                <td class="hidden-xs hidden-sm">user1@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                            ...
                            <tr class="danger">
                                <td class="cell-small text-center"><input type="checkbox" id="check7-td1" name="check7-td1"></td>
                                <td class="text-center">2</td>
                                <td><a href="javascript:void(0)">username2</a></td>
                                <td class="hidden-xs hidden-sm">user2@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                            ...
                            <tr class="warning">
                                <td class="cell-small text-center"><input type="checkbox" id="check7-td2" name="check7-td2"></td>
                                <td class="text-center">3</td>
                                <td><a href="javascript:void(0)">username3</a></td>
                                <td class="hidden-xs hidden-sm">user3@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                            ...
                            <tr class="active">
                                <td class="cell-small text-center"><input type="checkbox" id="check7-td3" name="check7-td3"></td>
                                <td class="text-center">4</td>
                                <td><a href="javascript:void(0)">username4</a></td>
                                <td class="hidden-xs hidden-sm">user4@example.com</td>
                                <td class="hidden-xs hidden-sm">Name</td>
                            ...
                            <tr class="warning">
                                <td class="cell-small text-center"><input type="checkbox" id="check7-td4" name="check7-td4"></td>
                            ...
                            <tr class="success">
                                <td class="cell-small text-center"><input type="checkbox" id="check7-td5" name="check7-td5"></td>
                            ...
                            <tr class="active">
                                <td class="cell-small text-center"><input type="checkbox" id="check7-td6" name="check7-td6"></td>
                            ...
                            <tr class="warning">
                                <td class="cell-small text-center"><input type="checkbox" id="check7-td7" name="check7-td7"></td>
